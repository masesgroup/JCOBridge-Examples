...
name := "scalaclass"
organization := "MASES s.r.l."
version := "1.0"

unmanagedJars in Compile += file("C:/Program Files/MASES Group/JCOB/Core/JCOBridge.jar")
unmanagedJars in Runtime += file("C:/Program Files/MASES Group/JCOB/Core/JCOBridge.jar")
